...
!EOP
	...
	use CYGNSSsm_obsMod,           only : CYGNSSsm_obsinit
    ...
    call registerdaobssetup(trim(LDT_CYGNSSsmobsId)//char(0),&
         CYGNSSsm_obsinit)
    call registerdaobsread(trim(LDT_CYGNSSsmobsId)//char(0),&
         readCYGNSSsmObs)
